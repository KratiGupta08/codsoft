...
public class QuizApp {
    static class Question {
        ...
        public static void main(String[] args) {
            ...
            quiz.add(
                    new Question("What is the capital of France?", new String[] { "Paris", "Rome", "Berlin", "Madrid" },
                            0));
            ...
            quiz.add(new Question("Which programming language is known as 'Write Once, Run Anywhere'?",
                    new String[] { "Python", "C++", "Java", "JavaScript" }, 2));
            quiz.add(new Question("What is the square root of 16?", new String[] { "2", "4", "8", "16" }, 1));
            runQuiz(quiz);
        }
